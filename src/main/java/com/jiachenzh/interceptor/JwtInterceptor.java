package com.jiachenzh.interceptor;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (authHeader != null && authHeader.startsWith(TOKEN_PERFIX)) {
            ...
            if (claims != null) {
                ...
                if(UserRoleEnum.TEACHER_ROLE.getDesc().equals(claims.get(ROLES_KEY))){//如果是老师
                    request.setAttribute(AbstractUserAuthorizationType.TEACHER_AUTHORIZATION_KEY, claims);
                }
            }
        }
        return true;
